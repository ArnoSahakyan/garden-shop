...
export function Conact() {
	return (
		<div className="container">
			<h1>Contact</h1>
			<div className="cards">
				<div className="card-top">
					<div className="card-top-item item1">
						<h1>Phone</h1>
						<Link to="/" className="phone">
							+7 (499) 350-66-04
						</Link>
					</div>
					<div className="card-top-item item2">
						<h1>Socials</h1>
						<div>
							<Link to="/">
								<svg
				...
				<div className="card-bottom">
					<div className="card-bottom-item item1">
						<h1>Address</h1>
						<Link to="/">Dubininskaya Ulitsa, 96, Moscow, Russia, 115093</Link>
					</div>
					<div className="card-bottom-item item2">
						<h4>Working Hours</h4>
